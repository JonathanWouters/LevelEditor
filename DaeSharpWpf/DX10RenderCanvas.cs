...
namespace DaeSharpWpf
{
    ...
    public partial class DX10RenderCanvas : Image
    {
        ...
        public Color4 ClearColor = new SharpDX.Color4(0.16f, 0.16f, 0.16f, 1.0f);
       ...
       public static readonly DependencyProperty MyUserProperty =
            DependencyProperty.Register("Viewport", typeof(IDX10Viewport), typeof(DX10RenderCanvas), new PropertyMetadata(default(IDX10Viewport)));

        public IDX10Viewport Viewport
        {
            get { return (IDX10Viewport)GetValue(MyUserProperty); }
            set {
